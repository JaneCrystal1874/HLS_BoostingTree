...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("feature_stream_V_TDATA", 32, hls_in, 0, "axis", "in_data", 1),
	Port_Property("feature_stream_V_TVALID", 1, hls_in, 0, "axis", "in_vld", 1),
	Port_Property("feature_stream_V_TREADY", 1, hls_out, 0, "axis", "in_acc", 1),
	Port_Property("prediction_sbp_V_TDATA", 32, hls_out, 1, "axis", "out_data", 1),
	Port_Property("prediction_sbp_V_TVALID", 1, hls_out, 1, "axis", "out_vld", 1),
	Port_Property("prediction_sbp_V_TREADY", 1, hls_in, 1, "axis", "out_acc", 1),
	Port_Property("prediction_dbp_V_TDATA", 32, hls_out, 2, "axis", "out_data", 1),
	Port_Property("prediction_dbp_V_TVALID", 1, hls_out, 2, "axis", "out_vld", 1),
	Port_Property("prediction_dbp_V_TREADY", 1, hls_in, 2, "axis", "out_acc", 1),
...
const char* HLS_Design_Meta::dut_name = "predict_ensemble";
