...
// ==============================================================
#ifndef __predict_ensemble_fn0__HH__
#define __predict_ensemble_fn0__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(predict_ensemble_fn0) {
    ...
    SC_CTOR(predict_ensemble_fn0):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
