...
// ==============================================================
#ifndef __predict_ensemble_JfO_H__
#define __predict_ensemble_JfO_H__
...
struct predict_ensemble_JfO_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(predict_ensemble_JfO_ram) {
        ram[0] = "0b00001";
        ram[1] = "0b00011";
        ram[2] = "0b00101";
        ram[3] = "0b00000";
...
SC_MODULE(predict_ensemble_JfO) {
...
predict_ensemble_JfO_ram* meminst;


SC_CTOR(predict_ensemble_JfO) {
meminst = new predict_ensemble_JfO_ram("predict_ensemble_JfO_ram");
